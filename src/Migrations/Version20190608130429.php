 ...
 */
final class Version20190608130429 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE category ADD created_at DATETIME DEFAULT \'current_timestamp()\' NOT NULL');
